...
export default function CounterFour() {
    ...
    const handleDelete = (index) => {
        if (counters.length > 1) {
            //filter crea una nuova lista di contatori, escludendo quello che da eliminare. La funzione filter ritorna tutti gli elementi tranne quello con l'indice == a index.
